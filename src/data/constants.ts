...
export const EXPERIENCE: Experience[] = [
  {
    ...
    description: [
      "Worked as a Data Analyst Intern for 4 months.",
      "Developed new Form and Tree structure accessibility features in PDFs for visually impaired users.",
      "Used PAC Accessibility Checker and PREP.",
    ],
    skills: [
      SkillNames.JS,
    ],
...
export const EDUCATION: Education[] = [
  ...
  },
  {
    ...
    institution: "Sri Gowtham Junior College",
...
export const CERTIFICATIONS: string[] = [
  "Participated in national-level Bharatiya Antariksh Hackathon 2025.",
  "MEAN Stack Development certification by LernX.",
  "AWS CloudVerse certificate by AWS Cloud Club in collaboration with the AWS User Group Vadodara.",
  "UI/UX DESIGNS BY lernX",
  "DSA INTERNSHIP FROM LearnFlu",
  "4-week virtual internship on Artificial Intelligence and Data Analytics focused on Green Skills, organized by AICTE",
  "Participated in Backend Reloaded hacathon presented by MOTIA",
  "Participated in AIML_SPRINT presented by BYTEXL"
];
